...
public class TreeMapWithCustomClassButWithoutComaparator {

	public static void main(String[] args) {

		TreeMap<Integer, CustomClassCreatedForBook> t1 = new TreeMap<>();
		...
		for (Map.Entry<Integer, CustomClassCreatedForBook> m1 : t1.entrySet()) {
